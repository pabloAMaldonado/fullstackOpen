...
const BlogWithToggle = (props) => {
  ...
  return <Blog.Blog {...props} isFull={isFull} toggleExpand={toggleExpand} />
}
...
test('blog initially only shows blog s title and author', () => {
  ...
  render(<Blog.Blog blog={blog} isFull={false} />)
...
test('When the blog form is filled and submitted, the blog s details are returned correctly', async () => {
  ...
  render(<Blog.FormBlogs setShow={setShow} blogs={blogs} setBlogs={setBlogs} setNoti={setNoti} />)
